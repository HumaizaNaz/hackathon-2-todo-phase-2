...
// Validate ../../../src/app/dashboard/todos/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/dashboard/todos">> = Specific
  const handler = {} as typeof import("../../../src/app/dashboard/todos/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

module.exports = [
"[project]/Desktop/docs/hackatho-2/phase-2/frontend/node_modules/better-auth/dist/adapters/memory-adapter/memory-adapter.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const memoryAdapter = (db, config)=>{
    ...
    let adapterCreator = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$docs$2f$hackatho$2d$2$2f$phase$2d$2$2f$frontend$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$adapter$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdapterFactory"])({
        config: {
            adapterId: "memory",
        ...
        adapter: ({ getFieldName, options, getModelName })=>{
            ...
            function convertWhereClause(where, model, join) {
                const execute = (where$1, model$1)=>{
                    ...
                    if (!table) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$docs$2f$hackatho$2d$2$2f$phase$2d$2$2f$frontend$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$env$2d$DbssmzoK$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__i__as__logger$3e$__["logger"].error(`[MemoryAdapter] Model ${model$1} not found in the DB`, Object.keys(db));
                ...
                for (const baseRecord of baseRecords){
                    ...
                    for (const [joinModel, joinAttr] of Object.entries(join)){
                        ...
                        if (!joinTable) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$docs$2f$hackatho$2d$2$2f$phase$2d$2$2f$frontend$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$env$2d$DbssmzoK$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__i__as__logger$3e$__["logger"].error(`[MemoryAdapter] JoinOption model ${joinModelName} not found in the DB`, Object.keys(db));
...
"[project]/Desktop/docs/hackatho-2/phase-2/frontend/node_modules/better-auth/dist/adapters/memory-adapter/index.mjs [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$docs$2f$hackatho$2d$2$2f$phase$2d$2$2f$frontend$2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$memory$2d$adapter$2f$memory$2d$adapter$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/docs/hackatho-2/phase-2/frontend/node_modules/better-auth/dist/adapters/memory-adapter/memory-adapter.mjs [app-route] (ecmascript)");
;
;
}),
"[project]/Desktop/docs/hackatho-2/phase-2/frontend/node_modules/better-auth/dist/adapters/memory-adapter/index.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "memoryAdapter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$docs$2f$hackatho$2d$2$2f$phase$2d$2$2f$frontend$2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$memory$2d$adapter$2f$memory$2d$adapter$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["memoryAdapter"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$docs$2f$hackatho$2d$2$2f$phase$2d$2$2f$frontend$2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$memory$2d$adapter$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Desktop/docs/hackatho-2/phase-2/frontend/node_modules/better-auth/dist/adapters/memory-adapter/index.mjs [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$docs$2f$hackatho$2d$2$2f$phase$2d$2$2f$frontend$2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$memory$2d$adapter$2f$memory$2d$adapter$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/docs/hackatho-2/phase-2/frontend/node_modules/better-auth/dist/adapters/memory-adapter/memory-adapter.mjs [app-route] (ecmascript)");
}),
];

//# sourceMappingURL=95131_better-auth_dist_adapters_memory-adapter_02eea066._.js.map